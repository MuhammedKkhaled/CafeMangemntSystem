        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    ?>
                    <form method="post" action="admin/stocks/addFoodProduct.php">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">اسم المنتج </label>
                            <input type="text" class="form-control" id="exampleInputEmail1" name="food_name" autocomplete="off" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">سعر المنتج </label>
                            <input type="number" class="form-control" id="exampleInputPassword1" min="1" name="food_price" required>
                        </div>
