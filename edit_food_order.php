...
if (isset($_SESSION['username'])) {
    ...
    $productsQuery = "SELECT fp.food_name, fpo.quantity, fpo.each_price, fpo.total_price AS product_total_price
                      FROM food_products_order fpo
                      JOIN foodcar_products fp ON fpo.food_product_id = fp.id
                      WHERE fpo.food_order_id = $orderId";
...
?>
        ...
        <script>
            document.getElementById("addclick").addEventListener('click', function(event) {
                ...
                var orderNumber = "<?= $orderId ?>"; // Get the order number from PHP
            ...
            fetch("pages/get_food_car_products.php")
                .then(response => {
                    ...
                    data.forEach(product => {
                        ...
                        optionElement.text = product.food_name; // Adjust this based on your product data
